...
enum EZrOwnershipBuiltinKind {
    ...
    ZR_OWNERSHIP_BUILTIN_KIND_UNIQUE = 1,
    ZR_OWNERSHIP_BUILTIN_KIND_SHARE = 2,
    ZR_OWNERSHIP_BUILTIN_KIND_DEGRADE = 3,
    ZR_OWNERSHIP_BUILTIN_KIND_BORROW = 4,
    ZR_OWNERSHIP_BUILTIN_KIND_LOAN = 5,
    ZR_OWNERSHIP_BUILTIN_KIND_WAKE = 6,
    ZR_OWNERSHIP_BUILTIN_KIND_DROP = 7,
    ZR_OWNERSHIP_BUILTIN_KIND_DETACH = 8,
    ZR_OWNERSHIP_BUILTIN_KIND_INTO_GC = 9,
    ZR_OWNERSHIP_BUILTIN_KIND_RETURN_LOAN = 10,
};
