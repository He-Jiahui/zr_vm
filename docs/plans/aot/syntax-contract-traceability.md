...
| `04/M2` | [Shared/Weak](../syntax/04-resource-ownership-drop-gc-bridge/m2-resource-shared-weak.md) | retain/release/upgrade 与 thread capability ABI | [05](./05-ownership-gc-and-bridge.md)、[09](./09-memory-management.md) | strong/weak lifecycle、cycle policy、upgrade failure | `partially_verified` |
