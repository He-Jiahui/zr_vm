...
- 最近更新时间：2026-08-31 09:12 +08:00。
- 总体状态：进行中。Task 4.27 让同一最优range/exactness priority下结构互相矛盾的
...
- 固定 GCC/Clang 快照中的 parser/display/call/query/relation/symbol/parity/source-contract 门禁分别为
  `74/22/30/30/23/21/15/70`，并补 canonical consumers `21/21`、semantic-facts `15/15`、
