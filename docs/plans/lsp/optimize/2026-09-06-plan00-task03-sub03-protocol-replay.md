...
ctest.exe --test-dir E:/Git/zr_vm/.codex/lsp-optimize-validation/msvc --output-on-failure -R "^language_server_stdio_(server_lifecycle|document_sync_conformance)$"
...
selected tests, including both inventory runners; the lifecycle and document-sync
replay adds another 2/2 passing tests.
