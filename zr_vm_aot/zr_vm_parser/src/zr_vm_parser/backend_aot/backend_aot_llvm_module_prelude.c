...
void backend_aot_write_llvm_runtime_helper_decls(FILE *file) {
    ...
    fprintf(file, "declare void @ZrCore_Value_CopySlow(ptr, ptr, ptr)\n");
    ...
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_SetConstant(ptr, ptr, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_CreateClosure(ptr, ptr, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_GetSubFunction(ptr, ptr, i32, i32)\n");
    ...
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_ToUInt(ptr, ptr, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_ToFloat(ptr, ptr, i32, i32)\n");
    ...
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_LogicalNotEqualBool(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_LogicalEqualSigned(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_LogicalNotEqualSigned(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_LogicalEqualUnsigned(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_LogicalNotEqualUnsigned(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_LogicalEqualFloat(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_LogicalNotEqualFloat(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_LogicalEqualString(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_LogicalNotEqualString(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_LogicalNot(ptr, ptr, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_LogicalAnd(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_LogicalOr(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_LogicalGreaterSigned(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_LogicalGreaterUnsigned(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_LogicalGreaterFloat(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_LogicalLessSigned(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_LogicalLessUnsigned(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_LogicalLessFloat(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_LogicalGreaterEqualSigned(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_LogicalGreaterEqualUnsigned(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_LogicalGreaterEqualFloat(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_LogicalLessEqualSigned(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_LogicalLessEqualUnsigned(ptr, ptr, i32, i32, i32)\n");
    ...
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_SubFloat(ptr, ptr, i32, i32, i32)\n");
    ...
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_AddIntConst(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_SubInt(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_SubIntConst(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_AddSigned(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_AddSignedConst(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_AddUnsigned(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_AddUnsignedConst(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_SubSigned(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_SubSignedConst(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_SubUnsigned(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_SubUnsignedConst(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_BitwiseNot(ptr, ptr, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_BitwiseAnd(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_BitwiseOr(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_BitwiseXor(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_BitwiseShiftLeft(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_BitwiseShiftRight(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_MulSigned(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_MulSignedConst(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_MulUnsigned(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_MulUnsignedConst(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_MulFloat(ptr, ptr, i32, i32, i32)\n");
    ...
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_DivSignedConst(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_DivUnsigned(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_DivUnsignedConst(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_DivFloat(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_Mod(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_ModSignedConst(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_ModUnsigned(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_ModUnsignedConst(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_ModFloat(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_Pow(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_PowSigned(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_PowUnsigned(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_PowFloat(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_ShiftLeft(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_ShiftLeftInt(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_ShiftRight(ptr, ptr, i32, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_ShiftRightInt(ptr, ptr, i32, i32, i32)\n");
    ...
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_GetMemberSlot(ptr, ptr, i32, i32, i32)\n");
    ...
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_SuperArrayAddInt4(ptr, ptr, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_SuperArrayAddInt4Const(ptr, ptr, i32, i32)\n");
    fprintf(file, "declare i1 @ZrLibrary_AotRuntime_SuperArrayFillInt4Const(ptr, ptr, i32, i32, i32)\n");
