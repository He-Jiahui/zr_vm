...
TZrBool backend_aot_can_write_c_static_direct_f64_no_arg_call(
    ...
    calleeEntry = backend_aot_typed_direct_f64_call_find_function_entry_by_flat_index(functionTable,
                                                                                     calleeFunctionIndex);
...
TZrBool backend_aot_can_write_c_static_direct_f64_two_arg_call(
    ...
    *outPassStateToThunk = (TZrBool)!backend_aot_c_can_emit_typed_f64_two_arg_state_free_thunk(calleeEntry->function);
    return ZR_TRUE;
}
...
TZrBool backend_aot_can_write_c_static_direct_f64_three_arg_call(
    ...
    *outPassStateToThunk = (TZrBool)!backend_aot_c_can_emit_typed_f64_three_arg_state_free_thunk(calleeEntry->function);
    return ZR_TRUE;
}
