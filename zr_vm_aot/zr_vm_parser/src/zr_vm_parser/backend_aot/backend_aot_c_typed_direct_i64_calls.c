...
TZrBool backend_aot_can_write_c_static_direct_i64_no_arg_call(
    ...
    calleeEntry = backend_aot_typed_direct_i64_call_find_function_entry_by_flat_index(functionTable,
                                                                                     calleeFunctionIndex);
...
TZrBool backend_aot_can_write_c_static_direct_i64_two_arg_call(
    ...
    *outPassStateToThunk = (TZrBool)!backend_aot_c_can_emit_typed_i64_two_arg_state_free_thunk(calleeEntry->function);
    return ZR_TRUE;
}
...
TZrBool backend_aot_can_write_c_static_direct_i64_three_arg_call(
    ...
    if (argumentCount != 3u ||
        ...
        !backend_aot_c_scalar_locals_has_i64_slot(functionIr, firstArgumentSlot) ||
        !backend_aot_c_scalar_locals_has_i64_slot(functionIr, secondArgumentSlot) ||
        !backend_aot_c_scalar_locals_has_i64_slot(functionIr, thirdArgumentSlot) ||
        !backend_aot_c_scalar_locals_i64_written_before(functionIr, firstArgumentSlot, execInstructionIndex) ||
        !backend_aot_c_scalar_locals_i64_written_before(functionIr, secondArgumentSlot, execInstructionIndex) ||
    ...
    *outPassStateToThunk = (TZrBool)!backend_aot_c_can_emit_typed_i64_three_arg_state_free_thunk(calleeEntry->function);
    return ZR_TRUE;
}
