...
typedef enum EZrProtocolId {
    ...
    ZR_PROTOCOL_ID_REF_LIKE = 9,
    ZR_PROTOCOL_ID_CONTIGUOUS_VIEW_MUTABLE = 10,
    ZR_PROTOCOL_ID_CONTIGUOUS_VIEW_READONLY = 11,
    ZR_PROTOCOL_ID_CONTIGUOUS_SOURCE_OWNER = 12,
    ZR_PROTOCOL_ID_CONTIGUOUS_SOURCE_NATIVE_PINNED = 13,
    ZR_PROTOCOL_ID_ASYNC_ITERATOR = 14,
    ZR_PROTOCOL_ID_TASK_JOB = 15,
    ZR_PROTOCOL_ID_TASK_SCHEDULER = 16,
    ZR_PROTOCOL_ID_THREAD_SCHEDULER = 17,
    ZR_PROTOCOL_ID_THREAD_SEND = 18,
    ZR_PROTOCOL_ID_THREAD_SYNC = 19,
    ZR_PROTOCOL_ID_STABLE_SLOT_SOURCE = 20,
    ZR_PROTOCOL_ID_MAX = ZR_PROTOCOL_ID_STABLE_SLOT_SOURCE
} EZrProtocolId;
...
struct ZR_STRUCT_ALIGN SZrObject {
    ...
    SZrHashKeyValuePair *cachedStringLookupPair2;
    SZrHashKeyValuePair *cachedIteratorSourcePair;
    SZrHashKeyValuePair *cachedIteratorCurrentPair;
    SZrHashKeyValuePair *cachedIteratorIndexPair;
    SZrHashKeyValuePair *cachedIteratorNextNodePair;
...
ZR_CORE_API TZrBool ZrCore_Object_TryIterMoveNextCachedRawIntArrayFast(struct SZrState *state,
