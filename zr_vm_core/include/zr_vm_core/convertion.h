...
(ZR_CHECK(STATE, ((EXPRESSION)->type == (TYPE_ENUM)), "type mismatch."),\
ZR_CAST(TARGET_TYPE, (EXPRESSION)))
...
#define ZR_CAST_NATIVE_FUNCTION_POINTER(STATE, EXP) ZR_CAST_CHECKED_NATIVE(STATE, FZrNativeFunction*, (EXP), ZR_VALUE_TYPE_FUNCTION, ZR_TRUE)
#define ZR_CAST_NATIVE_CLOSURE(STATE, EXP) ZR_CAST_CHECKED_NATIVE(STATE, SZrClosureNative*, (EXP), ZR_VALUE_TYPE_FUNCTION, ZR_TRUE)
#define ZR_CAST_VM_CLOSURE(STATE, EXP) ZR_CAST_CHECKED_NATIVE(STATE, SZrClosure*, (EXP), ZR_VALUE_TYPE_FUNCTION, ZR_FALSE)
