...
; [0] TYPEOF exec=3 type=0 effect=0 dst=1 op0=1 op1=0 deopt=1
; [1] TYPEOF exec=9 type=0 effect=1 dst=2 op0=2 op1=0 deopt=2
...
zr_aot_fn_0_ins_4:
  %t9 = call i1 @ZrLibrary_AotRuntime_BeginInstruction(ptr %state, ptr %frame, i32 4, i32 13)
  br i1 %t9, label %zr_aot_fn_0_ins_4_body, label %zr_aot_fn_0_fail
zr_aot_fn_0_ins_4_body:
  %t10 = call i1 @ZrLibrary_AotRuntime_PrepareStaticDirectCall(ptr %state, ptr %frame, i32 2, i32 2, i32 0, i32 1, ptr %direct_call)
  br i1 %t10, label %zr_aot_fn_0_ins_4_prepare_ok, label %zr_aot_fn_0_fail
zr_aot_fn_0_ins_4_prepare_ok:
  %t11 = call i64 @zr_aot_fn_1(ptr %state)
  %t12 = icmp ne i64 %t11, 0
  br i1 %t12, label %zr_aot_fn_0_ins_4_invoke_ok, label %zr_aot_fn_0_fail
zr_aot_fn_0_ins_4_invoke_ok:
  %t13 = call i1 @ZrLibrary_AotRuntime_FinishDirectCall(ptr %state, ptr %frame, ptr %direct_call, i32 1)
  br i1 %t13, label %zr_aot_fn_0_ins_4_finish_ok, label %zr_aot_fn_0_fail
zr_aot_fn_0_ins_4_finish_ok:
  %t14 = call i64 @ZrLibrary_AotRuntime_Return(ptr %state, ptr %frame, i32 2, i1 true)
  ret i64 %t14

zr_aot_fn_0_ins_5:
  %t15 = call i1 @ZrLibrary_AotRuntime_BeginInstruction(ptr %state, ptr %frame, i32 5, i32 8)
  br i1 %t15, label %zr_aot_fn_0_ins_5_body, label %zr_aot_fn_0_fail
zr_aot_fn_0_ins_5_body:
  %t16 = call i64 @ZrLibrary_AotRuntime_Return(ptr %state, ptr %frame, i32 2, i1 true)
  ret i64 %t16

zr_aot_fn_0_end_unsupported:
  %t17 = call i64 @ZrLibrary_AotRuntime_ReportUnsupportedInstruction(ptr %state, i32 0, i32 6, i32 0)
  ret i64 %t17
...
zr_aot_fn_1_ins_0_body:
  %t2 = call i1 @ZrLibrary_AotRuntime_GetClosureValue(ptr %state, ptr %frame, i32 2, i32 0)
...
zr_aot_fn_1_ins_1_body:
  %t4 = call i1 @ZrLibrary_AotRuntime_CopyStack(ptr %state, ptr %frame, i32 1, i32 2)
...
zr_aot_fn_1_ins_3_body:
  %t8 = call i1 @ZrLibrary_AotRuntime_TypeOf(ptr %state, ptr %frame, i32 1, i32 1)
...
zr_aot_fn_1_ins_4_body:
  %t10 = call i1 @ZrLibrary_AotRuntime_GetMember(ptr %state, ptr %frame, i32 1, i32 1, i32 0)
...
zr_aot_fn_1_ins_5_body:
  %t12 = call i1 @ZrLibrary_AotRuntime_GetGlobal(ptr %state, ptr %frame, i32 3)
...
zr_aot_fn_1_ins_6_body:
  %t14 = call i1 @ZrLibrary_AotRuntime_GetMember(ptr %state, ptr %frame, i32 3, i32 3, i32 1)
...
zr_aot_fn_1_ins_7_body:
  %t16 = call i1 @ZrLibrary_AotRuntime_CopyStack(ptr %state, ptr %frame, i32 2, i32 3)
...
zr_aot_fn_1_ins_8_body:
  %t18 = call i1 @ZrLibrary_AotRuntime_CopyConstant(ptr %state, ptr %frame, i32 3, i32 0)
...
zr_aot_fn_1_ins_9_body:
  %t20 = call i1 @ZrLibrary_AotRuntime_TypeOf(ptr %state, ptr %frame, i32 2, i32 2)
...
zr_aot_fn_1_ins_11_body:
  %t24 = call i1 @ZrLibrary_AotRuntime_CopyStack(ptr %state, ptr %frame, i32 3, i32 1)
...
zr_aot_fn_1_ins_12_body:
  %t26 = call i1 @ZrLibrary_AotRuntime_CopyStack(ptr %state, ptr %frame, i32 4, i32 2)
...
zr_aot_fn_1_ins_13_body:
  %t28 = call i1 @ZrLibrary_AotRuntime_CopyStack(ptr %state, ptr %frame, i32 3, i32 4)
...
zr_aot_fn_1_ins_14_body:
  %t30 = call i1 @ZrLibrary_AotRuntime_CopyConstant(ptr %state, ptr %frame, i32 4, i32 0)
...
zr_aot_fn_1_ins_16_body:
  %t34 = call i1 @ZrLibrary_AotRuntime_CopyConstant(ptr %state, ptr %frame, i32 5, i32 1)
...
zr_aot_fn_1_ins_17_body:
  %t36 = call i1 @ZrLibrary_AotRuntime_AddInt(ptr %state, ptr %frame, i32 6, i32 4, i32 5)
...
zr_aot_fn_1_ins_18_body:
  %t38 = call i1 @ZrLibrary_AotRuntime_CopyConstant(ptr %state, ptr %frame, i32 7, i32 2)
  br i1 %t38, label %zr_aot_fn_1_ins_19, label %zr_aot_fn_1_fail

zr_aot_fn_1_ins_19:
  %t39 = call i1 @ZrLibrary_AotRuntime_BeginInstruction(ptr %state, ptr %frame, i32 19, i32 0)
  br i1 %t39, label %zr_aot_fn_1_ins_19_body, label %zr_aot_fn_1_fail
zr_aot_fn_1_ins_19_body:
  %t40 = call i1 @ZrLibrary_AotRuntime_AddInt(ptr %state, ptr %frame, i32 8, i32 6, i32 7)
  br i1 %t40, label %zr_aot_fn_1_ins_20, label %zr_aot_fn_1_fail

zr_aot_fn_1_ins_20:
  %t41 = call i1 @ZrLibrary_AotRuntime_BeginInstruction(ptr %state, ptr %frame, i32 20, i32 8)
  br i1 %t41, label %zr_aot_fn_1_ins_20_body, label %zr_aot_fn_1_fail
zr_aot_fn_1_ins_20_body:
  %t42 = call i64 @ZrLibrary_AotRuntime_Return(ptr %state, ptr %frame, i32 8, i1 false)
  ret i64 %t42

zr_aot_fn_1_end_unsupported:
  %t43 = call i64 @ZrLibrary_AotRuntime_ReportUnsupportedInstruction(ptr %state, i32 1, i32 21, i32 0)
  ret i64 %t43

zr_aot_fn_1_fail:
  %t44 = call i64 @ZrLibrary_AotRuntime_FailGeneratedFunction(ptr %state, ptr %frame)
  ret i64 %t44
}
