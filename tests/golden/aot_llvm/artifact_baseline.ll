...
@zr_aot_source_hash = private unnamed_addr constant [8 x i8] c"unknown\00"
@zr_aot_zro_hash = private unnamed_addr constant [8 x i8] c"unknown\00"
...
; descriptor.sourceHash = unknown
; descriptor.zroHash = unknown
