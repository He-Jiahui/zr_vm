...
zr_aot_fn_0_ins_3_body:
  %t8 = call i1 @ZrLibrary_AotRuntime_CopyStack(ptr %state, ptr %frame, i32 1, i32 2)
...
zr_aot_fn_0_ins_4_body:
  %t10 = call i1 @ZrLibrary_AotRuntime_CopyStack(ptr %state, ptr %frame, i32 2, i32 1)
  br i1 %t10, label %zr_aot_fn_0_ins_5, label %zr_aot_fn_0_fail

zr_aot_fn_0_ins_5:
  %t11 = call i1 @ZrLibrary_AotRuntime_BeginInstruction(ptr %state, ptr %frame, i32 5, i32 13)
  br i1 %t11, label %zr_aot_fn_0_ins_5_body, label %zr_aot_fn_0_fail
zr_aot_fn_0_ins_5_body:
  %t12 = call i1 @ZrLibrary_AotRuntime_PrepareStaticDirectCall(ptr %state, ptr %frame, i32 2, i32 2, i32 0, i32 2, ptr %direct_call)
  br i1 %t12, label %zr_aot_fn_0_ins_5_prepare_ok, label %zr_aot_fn_0_fail
zr_aot_fn_0_ins_5_prepare_ok:
  %t13 = call i64 @zr_aot_fn_2(ptr %state)
  %t14 = icmp ne i64 %t13, 0
  br i1 %t14, label %zr_aot_fn_0_ins_5_invoke_ok, label %zr_aot_fn_0_fail
zr_aot_fn_0_ins_5_invoke_ok:
  %t15 = call i1 @ZrLibrary_AotRuntime_FinishDirectCall(ptr %state, ptr %frame, ptr %direct_call, i32 1)
  br i1 %t15, label %zr_aot_fn_0_ins_5_finish_ok, label %zr_aot_fn_0_fail
zr_aot_fn_0_ins_5_finish_ok:
  %t16 = call i64 @ZrLibrary_AotRuntime_Return(ptr %state, ptr %frame, i32 2, i1 true)
  ret i64 %t16

zr_aot_fn_0_ins_6:
  %t17 = call i1 @ZrLibrary_AotRuntime_BeginInstruction(ptr %state, ptr %frame, i32 6, i32 8)
  br i1 %t17, label %zr_aot_fn_0_ins_6_body, label %zr_aot_fn_0_fail
zr_aot_fn_0_ins_6_body:
  %t18 = call i64 @ZrLibrary_AotRuntime_Return(ptr %state, ptr %frame, i32 2, i1 true)
  ret i64 %t18

zr_aot_fn_0_end_unsupported:
  %t19 = call i64 @ZrLibrary_AotRuntime_ReportUnsupportedInstruction(ptr %state, i32 0, i32 7, i32 0)
  ret i64 %t19

zr_aot_fn_0_fail:
  %t20 = call i64 @ZrLibrary_AotRuntime_FailGeneratedFunction(ptr %state, ptr %frame)
  ret i64 %t20
}
