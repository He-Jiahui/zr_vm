...
shape admits a resolved direct call with no argument or up to two exact `int` or
`bool` identifiers or literals passed by value: each exceptional edge reaches
