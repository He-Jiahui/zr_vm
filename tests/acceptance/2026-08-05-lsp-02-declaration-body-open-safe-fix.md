...
| 完成时间 | 状态 | 完成项目 |
|---|---|---|
| 2026-08-05 17:13 +08:00 | 已完成 | `class Box`的`missing_declaration_body_open`保留EOF recovery primary、在同cursor发布零宽`{}` fix；generic LSP code action应用后v2重新绑定清除该code；主树GCC/Clang/MSVC定向parser 38/38与advanced editor验证均通过 |
