...
INVENTORY_STATUS_HANDLER(handle_implementation_request)
...
INVENTORY_STATUS_HANDLER(handle_folding_range_request)
INVENTORY_STATUS_HANDLER(handle_selection_range_request)
...
INVENTORY_STATUS_HANDLER(handle_document_link_request)
INVENTORY_STATUS_HANDLER(handle_code_lens_request)
INVENTORY_STATUS_HANDLER(handle_prepare_call_hierarchy_request)
INVENTORY_STATUS_HANDLER(handle_call_hierarchy_incoming_calls_request)
INVENTORY_STATUS_HANDLER(handle_call_hierarchy_outgoing_calls_request)
INVENTORY_STATUS_HANDLER(handle_prepare_type_hierarchy_request)
INVENTORY_STATUS_HANDLER(handle_type_hierarchy_supertypes_request)
INVENTORY_STATUS_HANDLER(handle_type_hierarchy_subtypes_request)
...
INVENTORY_STATUS_HANDLER(handle_prepare_rename_request)
INVENTORY_STATUS_HANDLER(handle_rename_request)
