...
int main(void) {
    ...
    passed = run_zero_inclusive_subtractive_query_case(
                     ...
                     "while_self_dependent_target_reading_subtract_zero_minus_zero_inclusive_subtractive_negative_offset_conditional_positive_delta",
                     ...
                     0,
                     ZR_TYPE_RANGE_INT64_MAX) &&
             run_zero_inclusive_subtractive_query_case(
                     state,
                     "while self-dependent target-reading subtract zero-minus zero-inclusive subtractive negative offset conditional negative delta guarded",
                     "while_self_dependent_target_reading_subtract_zero_minus_zero_inclusive_subtractive_negative_offset_conditional_negative_delta_guarded",
                     "- (choose ? step : step + bias)",
                     5,
                     5,
                     0,
                     ...
                     0);
    printf(
            "%s: LSP Local Expression Query Keeps Self-Dependent Target-Reading Zero-Inclusive Subtractive Negative Offset Conditional Delta Range\n",
            passed ? "PASS" : "FAIL");
