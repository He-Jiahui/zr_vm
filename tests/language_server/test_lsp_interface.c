...
static void test_lsp_callable_assignment_surfaces_exact_signature_and_parameter_scope(SZrState *state) {
    ...
    const TZrChar *content =
        ...
        "    }\n"
        "    pub property hp: int {\n"
        "        pub get { return this._hp; }\n"
        "        pub set { this._hp = value; }\n"
        "    }\n"
        "    pub fn heal(amount: int): int {\n"
        "        this.hp = this.hp + amount;\n"
        "        return this.hp;\n"
...
int main(void) {
    ...
    test_lsp_direct_call_signature_fails_closed_without_canonical_call_fact(state);
    TEST_DIVIDER();
    ...
    test_lsp_generic_receiver_signature_fails_closed_without_canonical_call_fact(state);
    TEST_DIVIDER();
