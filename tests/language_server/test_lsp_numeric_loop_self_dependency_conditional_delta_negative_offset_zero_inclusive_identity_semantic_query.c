...
static TZrBool run_zero_inclusive_identity_query_case(
        SZrState *state,
        const char *label,
        const char *uriStem,
...
int main(void) {
    ...
    passed = run_zero_inclusive_identity_query_case(
                     state,
                     "while self-dependent target-reading subtract zero-minus zero-inclusive negative plus zero offset conditional positive delta",
                     "while_self_dependent_target_reading_subtract_zero_minus_zero_inclusive_negative_plus_zero_offset_conditional_positive_delta",
                     "maybeDown + zero",
                     ...
                     0,
                     ZR_TYPE_RANGE_INT64_MAX) &&
             run_zero_inclusive_identity_query_case(
                     state,
                     "while self-dependent target-reading subtract zero-minus zero-inclusive negative plus zero offset conditional negative delta guarded",
                     "while_self_dependent_target_reading_subtract_zero_minus_zero_inclusive_negative_plus_zero_offset_conditional_negative_delta_guarded",
                     "maybeDown + zero",
                     "- (choose ? step : step + bias)",
                     5,
                     5,
             ...
             run_zero_inclusive_identity_query_case(
                     state,
                     "while self-dependent target-reading subtract zero-minus zero plus zero-inclusive negative offset conditional positive delta",
                     "while_self_dependent_target_reading_subtract_zero_minus_zero_plus_zero_inclusive_negative_offset_conditional_positive_delta",
                     "zero + maybeDown",
                     "+ (choose ? step : step + bias)",
                     5,
                     ZR_TYPE_RANGE_INT64_MAX,
             ...
             run_zero_inclusive_identity_query_case(
                     state,
                     "while self-dependent target-reading subtract zero-minus zero plus zero-inclusive negative offset conditional negative delta guarded",
                     "while_self_dependent_target_reading_subtract_zero_minus_zero_plus_zero_inclusive_negative_offset_conditional_negative_delta_guarded",
                     "zero + maybeDown",
                     "- (choose ? step : step + bias)",
                     5,
                     5,
             ...
             run_zero_inclusive_identity_query_case(
                     state,
                     "while self-dependent target-reading subtract zero-minus zero-inclusive negative minus zero offset conditional positive delta",
                     "while_self_dependent_target_reading_subtract_zero_minus_zero_inclusive_negative_minus_zero_offset_conditional_positive_delta",
                     "maybeDown - zero",
                     "+ (choose ? step : step + bias)",
                     5,
                     ZR_TYPE_RANGE_INT64_MAX,
             ...
             run_zero_inclusive_identity_query_case(
                     state,
                     "while self-dependent target-reading subtract zero-minus zero-inclusive negative minus zero offset conditional negative delta guarded",
                     "while_self_dependent_target_reading_subtract_zero_minus_zero_inclusive_negative_minus_zero_offset_conditional_negative_delta_guarded",
                     "maybeDown - zero",
                     "- (choose ? step : step + bias)",
                     5,
                     5,
                     ...
                     0);
    printf(
            "%s: LSP Local Expression Query Keeps Self-Dependent Target-Reading Zero-Inclusive Identity Negative Offset Conditional Delta Range\n",
            passed ? "PASS" : "FAIL");
