...
static void run_positive_bitwise_idempotent_wrapper_offset_case(
...
static void test_and_add_zero_left_wrapper_keeps_positive_offset_range(void) {
    run_positive_bitwise_idempotent_wrapper_offset_case(
            "selfdep_bitwise_and_add_zero_left_wrapper_offset.zr",
            "(unit + zero) & unit");
}

static void test_and_add_zero_right_wrapper_keeps_positive_offset_range(void) {
    run_positive_bitwise_idempotent_wrapper_offset_case(
            "selfdep_bitwise_and_add_zero_right_wrapper_offset.zr",
            "unit & (zero + unit)");
}

static void test_and_subtract_zero_left_wrapper_keeps_positive_offset_range(void) {
    run_positive_bitwise_idempotent_wrapper_offset_case(
            "selfdep_bitwise_and_subtract_zero_left_wrapper_offset.zr",
            "(unit - zero) & unit");
}

static void test_and_subtract_zero_right_wrapper_keeps_positive_offset_range(void) {
    run_positive_bitwise_idempotent_wrapper_offset_case(
            "selfdep_bitwise_and_subtract_zero_right_wrapper_offset.zr",
            "unit & (unit - zero)");
}

static void test_or_add_zero_left_wrapper_keeps_positive_offset_range(void) {
    run_positive_bitwise_idempotent_wrapper_offset_case(
            "selfdep_bitwise_or_add_zero_left_wrapper_offset.zr",
            "(zero + unit) | unit");
}

static void test_or_add_zero_right_wrapper_keeps_positive_offset_range(void) {
    run_positive_bitwise_idempotent_wrapper_offset_case(
            "selfdep_bitwise_or_add_zero_right_wrapper_offset.zr",
            "unit | (unit + zero)");
}

static void test_or_subtract_zero_left_wrapper_keeps_positive_offset_range(void) {
    run_positive_bitwise_idempotent_wrapper_offset_case(
            "selfdep_bitwise_or_subtract_zero_left_wrapper_offset.zr",
            "(unit - zero) | unit");
}

static void test_or_subtract_zero_right_wrapper_keeps_positive_offset_range(void) {
    run_positive_bitwise_idempotent_wrapper_offset_case(
            "selfdep_bitwise_or_subtract_zero_right_wrapper_offset.zr",
            "unit | (unit - zero)");
}

int main(void) {
    UNITY_BEGIN();
    RUN_TEST(test_and_add_zero_left_wrapper_keeps_positive_offset_range);
    RUN_TEST(test_and_add_zero_right_wrapper_keeps_positive_offset_range);
    RUN_TEST(test_and_subtract_zero_left_wrapper_keeps_positive_offset_range);
    RUN_TEST(test_and_subtract_zero_right_wrapper_keeps_positive_offset_range);
    RUN_TEST(test_or_add_zero_left_wrapper_keeps_positive_offset_range);
    RUN_TEST(test_or_add_zero_right_wrapper_keeps_positive_offset_range);
    RUN_TEST(test_or_subtract_zero_left_wrapper_keeps_positive_offset_range);
    RUN_TEST(test_or_subtract_zero_right_wrapper_keeps_positive_offset_range);
    return UNITY_END();
}
