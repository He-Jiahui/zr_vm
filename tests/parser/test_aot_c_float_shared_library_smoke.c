...
static void test_aot_c_generated_shared_library_compiles_typed_float_mod(void) {
    ...
    options.moduleName = "aot_c_float_mod_smoke";
    options.sourceHash = "float-mod-smoke";
    options.inputKind = ZR_AOT_INPUT_KIND_SOURCE;
    options.inputHash = "float-mod-smoke";
    options.requireExecutableLowering = ZR_TRUE;

    TEST_ASSERT_TRUE(ZrTests_Path_GetGeneratedArtifact("aot_c_float_shared_library",
                                                       "src",
                                                       "aot_c_float_mod_smoke",
                                                       ".c",
                                                       generatedCPath,
                                                       sizeof(generatedCPath)));
    TEST_ASSERT_TRUE(ZrTests_Path_GetGeneratedArtifact("aot_c_float_shared_library",
                                                       "lib",
                                                       "libaot_c_float_mod_smoke",
                                                       ".so",
                                                       sharedLibraryPath,
