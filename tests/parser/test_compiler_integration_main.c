...
extern void test_using_owner_generic_emits_release_cleanup(void);
extern void test_using_owner_generic_release_runs_before_return(void);
extern void test_using_owner_generic_release_runs_before_break(void);
extern void test_using_borrow_generic_emits_end_borrow_cleanup(void);
extern void test_using_borrow_generic_end_borrow_runs_before_return(void);
extern void test_using_loan_generic_returns_loan_to_source_on_scope_exit(void);
extern void test_using_loan_generic_returns_loan_before_break(void);
extern void test_struct_prototype_metadata_serializes_layout_size_and_align(void);
extern void test_function_frame_layout_metadata_marks_struct_parameter_inline(void);
extern void test_function_frame_layout_metadata_keeps_large_struct_arithmetic_temps_plain(void);
extern void test_function_frame_layout_metadata_keeps_member_slot_load_temps_plain(void);
extern void test_binary_roundtrip_preserves_function_frame_layout_metadata(void);
extern void test_owned_field_metadata_serializes_into_prototype_data(void);
extern void test_intrinsic_ownership_generic_fields_serialize_owner_metadata(void);
...
extern void test_ownership_intrinsic_share_expression_consumes_unique_owner(void);
extern void test_current_ownership_surface_emits_dedicated_opcodes(void);
extern void test_ownership_intrinsics_emit_dedicated_opcodes_and_execute(void);
extern void test_ownership_reference_views_and_gc_bridge_emit_dedicated_opcodes(void);
extern void test_ownership_unique_share_runtime_moves_source_to_null(void);
extern void test_ownership_reference_views_and_gc_bridge_runtime_follow_surface_contract(void);
...
extern void test_plugin_guard_module_share_uses_member_dispatch(void);
...
extern void test_ownership_intrinsic_compile_rejects_invalid_operands(void);
extern void test_plugin_guard_global_assignment_reports_escape_boundary(void);
extern void test_plugin_guard_member_assignment_reports_escape_boundary(void);
extern void test_plugin_guard_type_query_reports_escape_boundary(void);
extern void test_plugin_guard_decorator_reports_escape_boundary(void);
extern void test_plugin_guard_parameter_default_reports_escape_boundary(void);
extern void test_plugin_guard_signature_type_reports_escape_boundary(void);
extern void test_plugin_guard_foreach_binding_type_reports_escape_boundary(void);
...
int main(void) {
    ...
    RUN_TEST(test_using_owner_generic_emits_release_cleanup);
    RUN_TEST(test_using_owner_generic_release_runs_before_return);
    RUN_TEST(test_using_owner_generic_release_runs_before_break);
    RUN_TEST(test_using_borrow_generic_emits_end_borrow_cleanup);
    RUN_TEST(test_using_borrow_generic_end_borrow_runs_before_return);
    RUN_TEST(test_using_loan_generic_returns_loan_to_source_on_scope_exit);
    RUN_TEST(test_using_loan_generic_returns_loan_before_break);
    RUN_TEST(test_struct_prototype_metadata_serializes_layout_size_and_align);
    RUN_TEST(test_function_frame_layout_metadata_marks_struct_parameter_inline);
    RUN_TEST(test_function_frame_layout_metadata_keeps_large_struct_arithmetic_temps_plain);
    RUN_TEST(test_function_frame_layout_metadata_keeps_member_slot_load_temps_plain);
    RUN_TEST(test_binary_roundtrip_preserves_function_frame_layout_metadata);
    RUN_TEST(test_owned_field_metadata_serializes_into_prototype_data);
    RUN_TEST(test_intrinsic_ownership_generic_fields_serialize_owner_metadata);
    ...
    RUN_TEST(test_ownership_intrinsic_share_expression_consumes_unique_owner);
    RUN_TEST(test_current_ownership_surface_emits_dedicated_opcodes);
    RUN_TEST(test_ownership_intrinsics_emit_dedicated_opcodes_and_execute);
    RUN_TEST(test_ownership_reference_views_and_gc_bridge_emit_dedicated_opcodes);
    RUN_TEST(test_ownership_intrinsic_compile_rejects_invalid_operands);
    RUN_TEST(test_plugin_guard_global_assignment_reports_escape_boundary);
    RUN_TEST(test_plugin_guard_member_assignment_reports_escape_boundary);
    RUN_TEST(test_plugin_guard_type_query_reports_escape_boundary);
    RUN_TEST(test_plugin_guard_decorator_reports_escape_boundary);
    RUN_TEST(test_plugin_guard_parameter_default_reports_escape_boundary);
    RUN_TEST(test_plugin_guard_signature_type_reports_escape_boundary);
    RUN_TEST(test_plugin_guard_foreach_binding_type_reports_escape_boundary);
    ...
    RUN_TEST(test_plugin_guard_module_share_uses_member_dispatch);
    ...
    RUN_TEST(test_ownership_reference_views_and_gc_bridge_runtime_follow_surface_contract);
