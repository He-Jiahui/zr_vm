...
void test_aot_c_source_lowers_static_f64_calls_to_typed_thunks(void) {
    static const char *const emitterHeaderNeedles[] = {
            ...
            "backend_aot_c_can_emit_typed_f64_two_arg_state_free_thunk(const SZrFunction *function)",
            "backend_aot_c_can_emit_typed_f64_three_arg_thunk(const SZrFunction *function)",
            "backend_aot_c_can_emit_typed_f64_three_arg_state_free_thunk(const SZrFunction *function)",
    ...
    static const char *const emitterSourceNeedles[] = {
            ...
            "backend_aot_c_can_emit_typed_f64_two_arg_state_free_thunk(",
            "backend_aot_c_can_emit_typed_f64_three_arg_thunk(",
            "backend_aot_c_can_emit_typed_f64_three_arg_state_free_thunk(",
    ...
    static const char *const typedDirectCallNeedles[] = {
            ...
            "TZrBool typedF64TwoArgCallPassState",
            "TZrBool typedF64ThreeArgCallPassState",
    ...
    static const char *const typedDirectF64CallNeedles[] = {
            ...
            "backend_aot_c_can_emit_typed_f64_two_arg_state_free_thunk(calleeEntry->function)",
            "backend_aot_c_can_emit_typed_f64_three_arg_thunk(calleeEntry->function)",
            "backend_aot_c_can_emit_typed_f64_three_arg_state_free_thunk(calleeEntry->function)",
            "*outPassStateToThunk = (TZrBool)!backend_aot_c_can_emit_typed_f64_two_arg_state_free_thunk(",
            "*outPassStateToThunk = (TZrBool)!backend_aot_c_can_emit_typed_f64_three_arg_state_free_thunk(",
    };
