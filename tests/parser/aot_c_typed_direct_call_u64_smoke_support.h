#ifndef ZR_VM_TESTS_AOT_C_TYPED_DIRECT_CALL_U64_SMOKE_SUPPORT_H
#define ZR_VM_TESTS_AOT_C_TYPED_DIRECT_CALL_U64_SMOKE_SUPPORT_H
...
static void run_aot_c_typed_direct_call_u64_smoke_with_options(
    ...
    format_aot_c_typed_direct_call_u64_path(sourceDirectory,
                                            sizeof(sourceDirectory),
                                            testCase->projectDirectory,
                                            "src");
    format_aot_c_typed_direct_call_u64_path(binaryDirectory,
                                            sizeof(binaryDirectory),
                                            testCase->projectDirectory,
                                            "bin");
    format_aot_c_typed_direct_call_u64_path(generatedCDirectory,
                                            sizeof(generatedCDirectory),
                                            testCase->projectDirectory,
                                            "bin/aot_c/src");
    format_aot_c_typed_direct_call_u64_path(sharedLibraryDirectory,
    ...
    TEST_ASSERT_TRUE(ZrTests_Path_GetGeneratedArtifact("aot_c_typed_direct_call_u64",
                                                       testCase->projectDirectory,
    ...
    if (testCase->forbidTypedDirectCallMetadataGuard) {
        ...
        TEST_ASSERT_NULL(strstr(generatedCText, "ZrLibrary_AotRuntime_SyncUnsignedIntLocal(state, &frame,"));
    }
