...
static void test_aot_c_generated_shared_library_compiles_get_global_direct_copy(void) {
#if !defined(ZR_PLATFORM_UNIX)
    ...
    TEST_ASSERT_NOT_NULL(strstr(generatedCText, "#include \"zr_vm_core/global.h\""));
    TEST_ASSERT_NOT_NULL(strstr(generatedCText, "const SZrTypeValue *zr_aot_global_object"));
    TEST_ASSERT_NOT_NULL(strstr(generatedCText, "state->global->zrObject.type == ZR_VALUE_TYPE_OBJECT"));
    TEST_ASSERT_NOT_NULL(strstr(generatedCText,
                                "ZrCore_Value_Copy(state, zr_aot_destination, &state->global->zrObject);"));
    TEST_ASSERT_NULL(strstr(generatedCText, "ZrLibrary_AotRuntime_GetGlobal(state, &frame"));
    free(generatedCText);
...
static void test_aot_c_generated_shared_library_compiles_typeof_direct_reflection(void) {
#if !defined(ZR_PLATFORM_UNIX)
    ...
    generatedCText = read_text_file_owned_or_fail(generatedCPath);
    TEST_ASSERT_NOT_NULL(strstr(generatedCText, "#include \"zr_vm_core/reflection.h\""));
    ...
    TEST_ASSERT_NULL(strstr(generatedCText, "ZrLibrary_AotRuntime_TypeOf(state, &frame"));
    free(generatedCText);
...
static void test_aot_c_generated_shared_library_compiles_object_struct_conversions_direct_core_calls(void) {
#if !defined(ZR_PLATFORM_UNIX)
    ...
    generatedCText = read_text_file_owned_or_fail(generatedCPath);
    TEST_ASSERT_NOT_NULL(strstr(generatedCText, "#include \"zr_vm_core/execution.h\""));
    ...
    TEST_ASSERT_NOT_NULL(strstr(generatedCText, "ZrCore_Execution_ToObject(state,"));
    TEST_ASSERT_NOT_NULL(strstr(generatedCText, "ZrCore_Execution_ToStruct(state,"));
    TEST_ASSERT_NOT_NULL(strstr(generatedCText, "frame.function->constantValueLength"));
    TEST_ASSERT_NOT_NULL(strstr(generatedCText, "&frame.function->constantValueList"));
    TEST_ASSERT_NULL(strstr(generatedCText, "ZrLibrary_AotRuntime_ToObject(state, &frame"));
    TEST_ASSERT_NULL(strstr(generatedCText, "ZrLibrary_AotRuntime_ToStruct(state, &frame"));
    free(generatedCText);
...
static void test_aot_c_generated_shared_library_compiles_closure_value_direct_access(void) {
#if !defined(ZR_PLATFORM_UNIX)
    ...
    TEST_ASSERT_NOT_NULL(strstr(generatedCText, "ZrCore_ClosureNative_GetCaptureValue"));
    TEST_ASSERT_NOT_NULL(strstr(generatedCText, "ZrCore_ClosureValue_GetValue"));
    TEST_ASSERT_NOT_NULL(strstr(generatedCText, "ZrCore_Value_Barrier(state, zr_aot_barrier_object, zr_aot_source);"));
    TEST_ASSERT_NULL(strstr(generatedCText, "ZrLibrary_AotRuntime_GetClosureValue(state, &frame"));
    TEST_ASSERT_NULL(strstr(generatedCText, "ZrLibrary_AotRuntime_SetClosureValue(state, &frame"));
    free(generatedCText);
...
static void test_aot_c_generated_shared_library_compiles_dynamic_value_access_boundary(void) {
    ...
    TEST_ASSERT_NOT_NULL(strstr(generatedCText, "unsupported AOT dynamic value access"));
...
static void test_aot_c_generated_shared_library_compiles_meta_value_access_boundary(void) {
    ...
    TEST_ASSERT_NOT_NULL(strstr(generatedCText, "unsupported AOT meta value access"));
...
static void test_aot_c_generated_shared_library_compiles_to_string_direct_core_conversion(void) {
#if !defined(ZR_PLATFORM_UNIX)
    ...
    TEST_ASSERT_NOT_NULL(strstr(generatedCText, "ZrCore_Value_ConvertToString(state, zr_aot_source)"));
    TEST_ASSERT_NOT_NULL(strstr(generatedCText, "frame.slotBase = zr_aot_call_info->functionBase.valuePointer + 1;"));
    TEST_ASSERT_NOT_NULL(strstr(generatedCText, "ZrCore_Value_InitAsRawObject(state,"));
    TEST_ASSERT_NOT_NULL(strstr(generatedCText, "ZrCore_Value_ResetAsNull(zr_aot_destination);"));
    TEST_ASSERT_NULL(strstr(generatedCText, "ZrLibrary_AotRuntime_ToString(state, &frame"));
    free(generatedCText);
...
int main(void) {
    UNITY_BEGIN();
    RUN_TEST(test_aot_c_generated_shared_library_compiles_get_global_direct_copy);
    RUN_TEST(test_aot_c_generated_shared_library_compiles_typeof_direct_reflection);
    RUN_TEST(test_aot_c_generated_shared_library_compiles_object_struct_conversions_direct_core_calls);
    RUN_TEST(test_aot_c_generated_shared_library_compiles_closure_value_direct_access);
    ...
    RUN_TEST(test_aot_c_generated_shared_library_compiles_to_string_direct_core_conversion);
    return UNITY_END();
}
