...
extern void test_reference_full_stack_aot_matrix_fields_are_present(void);
...
extern void test_testing_validation_index_mentions_aot_matrix_tiers(void);
extern void test_projects_suite_registers_aot_large_fixtures(void);
