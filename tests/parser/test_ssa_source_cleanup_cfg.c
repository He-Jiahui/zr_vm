...
int main(void) {
    ...
    RUN_TEST(test_boolean_argument_is_captured_before_exception_cleanup);
    ...
    RUN_TEST(test_three_scalar_arguments_are_captured_before_exception_cleanup);
    RUN_TEST(test_four_arguments_stay_on_legacy_path);
