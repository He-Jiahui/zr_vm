...
static void test_while_self_dependent_target_reading_symbolic_deeper_three_additional_level_positive_singleton_scale_product_coefficient_residual_widens_upward(void) {
    const char *source =
            "while (flag) {\n"
    ...
    run_scale_product_coefficient_residual_case(
            "numeric_while_self_dependent_symbolic_deeper_three_additional_level_positive_singleton_scale_product_coefficient_residual_dataflow_test.zr",
            source,
            1,
            1,
            -1,
...
static void test_while_self_dependent_target_reading_symbolic_deeper_three_additional_level_positive_non_singleton_scale_product_coefficient_residual_widens_upward(void) {
    const char *source =
            "while (flag) {\n"
            "    narrowed = narrowed + (step * (factor * (scale * (outer * (span * (mask * gate))))));\n"
            "    other = narrowed;\n"
    ...
    run_scale_product_coefficient_residual_case(
            "numeric_while_self_dependent_symbolic_deeper_three_additional_level_positive_non_singleton_scale_product_coefficient_residual_dataflow_test.zr",
            source,
            2,
            3,
            -1,
...
static void test_while_self_dependent_target_reading_symbolic_deeper_three_additional_level_zero_inclusive_positive_scale_product_coefficient_residual_widens_upward(void) {
    const char *source =
            "while (flag) {\n"
            "    narrowed = narrowed + (step * (factor * (scale * (outer * (span * (mask * gate))))));\n"
            "    other = narrowed;\n"
    ...
    run_scale_product_coefficient_residual_case(
            "numeric_while_self_dependent_symbolic_deeper_three_additional_level_zero_inclusive_positive_scale_product_coefficient_residual_dataflow_test.zr",
            source,
            0,
            1,
            -1,
...
static void test_while_self_dependent_target_reading_symbolic_deeper_three_additional_level_zero_inclusive_negative_scale_product_coefficient_residual_widens_upward(void) {
    const char *source =
            "while (flag) {\n"
            "    narrowed = narrowed + (step * (factor * (scale * (outer * (span * (mask * gate))))));\n"
            "    other = narrowed;\n"
    ...
    run_scale_product_coefficient_residual_case(
            "numeric_while_self_dependent_symbolic_deeper_three_additional_level_zero_inclusive_negative_scale_product_coefficient_residual_dataflow_test.zr",
            source,
            -1,
            0,
            -1,
...
static void test_while_self_dependent_target_reading_symbolic_deeper_three_additional_level_negative_non_singleton_scale_product_coefficient_residual_widens_upward(void) {
    const char *source =
            "while (flag) {\n"
            "    narrowed = narrowed + (step * (factor * (scale * (outer * (span * (mask * gate))))));\n"
            "    other = narrowed;\n"
    ...
    run_scale_product_coefficient_residual_case(
            "numeric_while_self_dependent_symbolic_deeper_three_additional_level_negative_non_singleton_scale_product_coefficient_residual_dataflow_test.zr",
            source,
            -2,
            -1,
            -1,
...
static void test_while_self_dependent_target_reading_symbolic_deeper_three_additional_level_sign_crossing_scale_product_coefficient_residual_widens_upward(void) {
    const char *source =
            "while (flag) {\n"
            "    narrowed = narrowed + (step * (factor * (scale * (outer * (span * (mask * gate))))));\n"
            "    other = narrowed;\n"
    ...
    run_scale_product_coefficient_residual_case(
            "numeric_while_self_dependent_symbolic_deeper_three_additional_level_sign_crossing_scale_product_coefficient_residual_dataflow_test.zr",
            source,
            -1,
            1,
            -1,
...
static void test_while_self_dependent_target_reading_symbolic_deeper_three_additional_level_zero_only_scale_product_coefficient_noop_preserves_target(void) {
    const char *source =
            "while (flag) {\n"
            "    narrowed = narrowed + (step * (factor * (scale * (outer * (span * (mask * gate))))));\n"
            "    other = narrowed;\n"
    ...
    run_scale_product_coefficient_range_case(
            "numeric_while_self_dependent_symbolic_deeper_three_additional_level_zero_only_scale_product_coefficient_noop_dataflow_test.zr",
            source,
            0,
            0,
            -1,
...
int main(void) {
    UNITY_BEGIN();
    RUN_TEST(test_while_self_dependent_target_reading_symbolic_deeper_three_additional_level_positive_singleton_scale_product_coefficient_residual_widens_upward);
    RUN_TEST(test_while_self_dependent_target_reading_symbolic_deeper_three_additional_level_positive_non_singleton_scale_product_coefficient_residual_widens_upward);
    RUN_TEST(test_while_self_dependent_target_reading_symbolic_deeper_three_additional_level_zero_inclusive_positive_scale_product_coefficient_residual_widens_upward);
    RUN_TEST(test_while_self_dependent_target_reading_symbolic_deeper_three_additional_level_zero_inclusive_negative_scale_product_coefficient_residual_widens_upward);
    RUN_TEST(test_while_self_dependent_target_reading_symbolic_deeper_three_additional_level_negative_non_singleton_scale_product_coefficient_residual_widens_upward);
    RUN_TEST(test_while_self_dependent_target_reading_symbolic_deeper_three_additional_level_sign_crossing_scale_product_coefficient_residual_widens_upward);
    RUN_TEST(test_while_self_dependent_target_reading_symbolic_deeper_three_additional_level_zero_only_scale_product_coefficient_noop_preserves_target);
    return UNITY_END();
}
