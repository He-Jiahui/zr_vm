...
condition 1 strcmp(format, "KNOWN_VM_CALL: invalid known VM callable") == 0
run
bt 8
frame 1
...
printf "opA=%p type=%u native=%u gc=%u object=%p nativeInt=%lld\n", opA, opA->type, opA->isNative, opA->isGarbageCollectable, opA->value.object, opA->value.nativeObject.nativeInt64
