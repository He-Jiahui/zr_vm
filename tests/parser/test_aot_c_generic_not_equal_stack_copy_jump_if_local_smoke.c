...
static TZrInstruction create_generic_not_equal_instruction(TZrUInt16 destinationSlot,
                                                           TZrUInt16 leftSlot,
                                                           TZrUInt16 rightSlot) {
    TZrInstruction instruction;
...
static SZrFunction *create_generic_i64_stack_copy_not_equal_jump_if_function(SZrState *state) {
    ...
    function->instructionsList[3] = create_generic_not_equal_instruction(2u, 5u, 1u);
    function->instructionsList[4] = create_jump_if_instruction(2u, 2);
...
static void test_aot_c_generated_shared_library_executes_generic_not_equal_stack_copy_jump_if_local_branch(void) {
    ...
    const char *projectJson =
            "{"
            "\"name\":\"aot-runtime-generic-not-equal-stack-copy-jump-if-smoke\","
            "\"source\":\"src\","
            "\"binary\":\"bin\","
            "\"entry\":\"main\""
            "}";
    ...
    TEST_ASSERT_NOT_NULL(state);
    function = create_generic_i64_stack_copy_not_equal_jump_if_function(state);
    TEST_ASSERT_NOT_NULL(function);

    TEST_ASSERT_TRUE(ZrTests_Path_GetGeneratedArtifact("aot_c_shared_library",
                                                       "generic_not_equal_stack_copy_jump_if_local_project",
                                                       "runtime_generic_not_equal_stack_copy_jump_if_smoke",
                                                       ".zrp",
                                                       projectPath,
                                                       sizeof(projectPath)));
    TEST_ASSERT_TRUE(ZrTests_Path_GetGeneratedArtifact("aot_c_shared_library",
                                                       "generic_not_equal_stack_copy_jump_if_local_project/src",
                                                       "main",
                                                       ".zr",
                                                       sourcePath,
                                                       sizeof(sourcePath)));
    TEST_ASSERT_TRUE(ZrTests_Path_GetGeneratedArtifact("aot_c_shared_library",
                                                       "generic_not_equal_stack_copy_jump_if_local_project/bin",
                                                       "main",
                                                       ".zro",
                                                       zroPath,
                                                       sizeof(zroPath)));
    TEST_ASSERT_TRUE(ZrTests_Path_GetGeneratedArtifact("aot_c_shared_library",
                                                       "generic_not_equal_stack_copy_jump_if_local_project/bin/aot_c/src",
                                                       "main",
                                                       ".c",
                                                       generatedCPath,
                                                       sizeof(generatedCPath)));
    TEST_ASSERT_TRUE(ZrTests_Path_GetGeneratedArtifact("aot_c_shared_library",
                                                       "generic_not_equal_stack_copy_jump_if_local_project/bin/aot_c/lib",
                                                       "zrvm_aot_main",
                                                       ".so",
                                                       sharedLibraryPath,
    ...
    TEST_ASSERT_NOT_NULL(strstr(generatedCText, "goto zr_aot_fn_0_ins_7;"));
    TEST_ASSERT_NULL(strstr(generatedCText,
                            "ZrLibrary_AotRuntime_GenericPrimitiveLogicalNotEqual(state, &frame, 2, 5, 1)"));
