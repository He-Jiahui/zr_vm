...
static void run_zero_inclusive_sum_case(
        const char *sourceNameText,
        TZrInt64 maybeLowerMinValue,
        TZrInt64 maybeLowerMaxValue,
    ...
    register_int64_range_variable(cs, "maybeLower", maybeLowerMinValue, maybeLowerMaxValue);
    ...
    written = snprintf(
            ...
            sizeof(source),
            "while (flag) {\n"
            "    other = (+narrowed) - (zero - (maybeDown + maybeLower));\n"
            "    mirror = other;\n"
            "    narrowed = narrowed %s;\n"
            "}\n"
            "narrowed + 0;\n"
...
static void test_while_self_dependent_target_reading_subtract_zero_minus_zero_inclusive_negative_sum_offset_conditional_positive_delta_keeps_upward_range(void) {
    run_zero_inclusive_sum_case(
            "numeric_while_self_dependent_target_reading_subtract_zero_minus_zero_inclusive_negative_sum_offset_conditional_positive_delta_dataflow_test.zr",
            -2,
            0,
...
static void test_while_self_dependent_target_reading_subtract_zero_minus_zero_inclusive_negative_sum_offset_conditional_negative_delta_stays_guarded(void) {
    run_zero_inclusive_sum_case(
            "numeric_while_self_dependent_target_reading_subtract_zero_minus_zero_inclusive_negative_sum_offset_conditional_negative_delta_guarded_dataflow_test.zr",
            -2,
            0,
            "- (choose ? step : step + bias)",
            5,
...
static void test_while_self_dependent_target_reading_subtract_zero_minus_zero_inclusive_plus_strict_negative_sum_offset_conditional_positive_delta_keeps_upward_range(void) {
    run_zero_inclusive_sum_case(
            "numeric_while_self_dependent_target_reading_subtract_zero_minus_zero_inclusive_plus_strict_negative_sum_offset_conditional_positive_delta_dataflow_test.zr",
            -2,
            -1,
            "+ (choose ? step : step + bias)",
            5,
...
static void test_while_self_dependent_target_reading_subtract_zero_minus_zero_inclusive_plus_strict_negative_sum_offset_conditional_negative_delta_stays_guarded(void) {
    run_zero_inclusive_sum_case(
            "numeric_while_self_dependent_target_reading_subtract_zero_minus_zero_inclusive_plus_strict_negative_sum_offset_conditional_negative_delta_guarded_dataflow_test.zr",
            -2,
            -1,
            "- (choose ? step : step + bias)",
            5,
...
int main(void) {
    UNITY_BEGIN();
    RUN_TEST(test_while_self_dependent_target_reading_subtract_zero_minus_zero_inclusive_negative_sum_offset_conditional_positive_delta_keeps_upward_range);
    RUN_TEST(test_while_self_dependent_target_reading_subtract_zero_minus_zero_inclusive_negative_sum_offset_conditional_negative_delta_stays_guarded);
    RUN_TEST(test_while_self_dependent_target_reading_subtract_zero_minus_zero_inclusive_plus_strict_negative_sum_offset_conditional_positive_delta_keeps_upward_range);
    RUN_TEST(test_while_self_dependent_target_reading_subtract_zero_minus_zero_inclusive_plus_strict_negative_sum_offset_conditional_negative_delta_stays_guarded);
    return UNITY_END();
}
