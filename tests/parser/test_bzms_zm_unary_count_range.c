...
int main(void) {
    ...
    RUN_TEST(test_or_zero_left_with_shift_right_zero_minus_unary_minus_exact_zero_or_count_zero_minus_rhs_records_unit_range);
    RUN_TEST(test_or_zero_left_with_shift_left_zero_minus_unary_minus_exact_zero_or_inner_unary_minus_count_zero_minus_rhs_records_unit_range);
    RUN_TEST(test_or_zero_left_with_shift_right_zero_minus_unary_minus_inner_unary_minus_count_xor_exact_zero_zero_minus_rhs_records_unit_range);
    RUN_TEST(test_or_zero_left_with_shift_left_zero_minus_unary_minus_additive_count_zero_minus_unary_rhs_records_negative_unit_range);
    RUN_TEST(test_or_zero_left_with_shift_right_zero_minus_unary_minus_exact_zero_or_count_zero_minus_unary_rhs_records_negative_unit_range);
    RUN_TEST(test_or_zero_left_with_shift_left_zero_minus_unary_minus_exact_zero_or_inner_unary_minus_count_zero_minus_unary_rhs_records_negative_unit_range);
    RUN_TEST(test_or_zero_left_with_shift_right_zero_minus_unary_minus_inner_unary_minus_count_xor_exact_zero_zero_minus_unary_rhs_records_negative_unit_range);
    return UNITY_END();
}
