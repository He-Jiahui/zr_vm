...
static void test_aot_c_source_lowers_primitive_constants_to_direct_value_writes(void) {
    ...
    static const char *const valueSourceNeedles[] = {
            ...
            "backend_aot_c_scalar_stack_copy_source_reaching_runtime_scalar_kind_mask_before(",
            "sourceKindMask & ZR_AOT_RUNTIME_SCALAR_KIND_BOOL",
            "sourceKindMask & ZR_AOT_RUNTIME_SCALAR_KIND_I64",
            "sourceKindMask & ZR_AOT_RUNTIME_SCALAR_KIND_U64",
            "sourceKindMask & ZR_AOT_RUNTIME_SCALAR_KIND_F64",
...
static void test_aot_c_source_mirrors_scalar_stack_copy_to_c_locals(void) {
    ...
    static const char *const functionBodyNeedles[] = {
            ...
            "backend_aot_call_argument_count(",
            "backend_aot_find_exec_ir_instruction(module, functionIr, instructionIndex)",
            "backend_aot_exec_ir_instruction_has_stable_call_arguments(execIrInstruction)",
...
static void test_aot_c_source_emits_typed_scalar_local_declarations(void) {
    ...
    static const char *const sourceNeedles[] = {
            ...
            "backend_aot_c_scalar_locals_compute_block_entry_state(",
