...
static void test_aot_c_source_lowers_generic_power_meta_boundary_to_direct_c(void) {
    static const char *const headerNeedles[] = {
...
int main(void) {
    ...
    RUN_TEST(test_aot_c_source_lowers_generic_power_meta_boundary_to_direct_c);
    return UNITY_END();
}
