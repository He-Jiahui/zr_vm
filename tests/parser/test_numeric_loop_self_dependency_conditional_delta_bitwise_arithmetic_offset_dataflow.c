...
static void test_while_self_dependent_target_reading_nested_commuted_bitwise_identity_zero_over_divided_range_offset_conditional_delta_keeps_upward_range(void) {
    SZrCompilerState *cs = create_compiler_state();
    const char *sourceNameText =
            "numeric_while_self_dependent_target_reading_nested_commuted_bitwise_identity_zero_over_divided_range_offset_conditional_delta_dataflow_test.zr";
    const char *source =
            "while (flag) {\n"
...
static void test_while_self_dependent_target_reading_nested_commuted_bitwise_identity_zero_over_left_shift_range_offset_conditional_delta_keeps_upward_range(void) {
    SZrCompilerState *cs = create_compiler_state();
    const char *sourceNameText =
            "numeric_while_self_dependent_target_reading_nested_commuted_bitwise_identity_zero_over_left_shift_range_offset_conditional_delta_dataflow_test.zr";
    const char *source =
            "while (flag) {\n"
...
static void test_while_self_dependent_target_reading_nested_commuted_bitwise_identity_zero_over_right_shift_range_offset_conditional_delta_keeps_upward_range(void) {
    SZrCompilerState *cs = create_compiler_state();
    const char *sourceNameText =
            "numeric_while_self_dependent_target_reading_nested_commuted_bitwise_identity_zero_over_right_shift_range_offset_conditional_delta_dataflow_test.zr";
    const char *source =
            "while (flag) {\n"
            "    other = narrowed - (zero | (unit >> shift));\n"
            "    mirror = other;\n"
...
static void test_while_self_dependent_target_reading_nested_commuted_bitwise_identity_zero_over_modulo_plus_range_offset_conditional_delta_keeps_upward_range(void) {
    SZrCompilerState *cs = create_compiler_state();
    const char *sourceNameText =
            "numeric_while_self_dependent_target_reading_nested_commuted_bitwise_identity_zero_over_modulo_plus_range_offset_conditional_delta_dataflow_test.zr";
    const char *source =
            "while (flag) {\n"
...
static void test_while_self_dependent_target_reading_nested_commuted_bitwise_identity_zero_over_unary_plus_range_offset_conditional_delta_keeps_upward_range(void) {
    SZrCompilerState *cs = create_compiler_state();
    const char *sourceNameText =
            "numeric_while_self_dependent_target_reading_nested_commuted_bitwise_identity_zero_over_unary_plus_range_offset_conditional_delta_dataflow_test.zr";
    const char *source =
            "while (flag) {\n"
...
int main(void) {
    UNITY_BEGIN();
    RUN_TEST(test_while_self_dependent_target_reading_nested_commuted_bitwise_identity_zero_over_divided_range_offset_conditional_delta_keeps_upward_range);
    RUN_TEST(test_while_self_dependent_target_reading_nested_commuted_bitwise_identity_zero_over_left_shift_range_offset_conditional_delta_keeps_upward_range);
    RUN_TEST(test_while_self_dependent_target_reading_nested_commuted_bitwise_identity_zero_over_right_shift_range_offset_conditional_delta_keeps_upward_range);
    RUN_TEST(test_while_self_dependent_target_reading_nested_commuted_bitwise_identity_zero_over_modulo_plus_range_offset_conditional_delta_keeps_upward_range);
    RUN_TEST(test_while_self_dependent_target_reading_nested_commuted_bitwise_identity_zero_over_unary_plus_range_offset_conditional_delta_keeps_upward_range);
    return UNITY_END();
}
