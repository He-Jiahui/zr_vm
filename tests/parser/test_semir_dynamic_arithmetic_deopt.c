...
static void test_generic_arithmetic_exec_opcode_becomes_dynamic_deopt_boundary(void) {
    ...
    assert_dynamic_arithmetic_deopts(ZR_INSTRUCTION_ENUM(MUL));
    assert_dynamic_arithmetic_deopts(ZR_INSTRUCTION_ENUM(DIV));
    assert_dynamic_arithmetic_deopts(ZR_INSTRUCTION_ENUM(MOD));
    assert_dynamic_arithmetic_deopts(ZR_INSTRUCTION_ENUM(LOGICAL_EQUAL));
