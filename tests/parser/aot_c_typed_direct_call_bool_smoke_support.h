#ifndef ZR_VM_TESTS_AOT_C_TYPED_DIRECT_CALL_BOOL_SMOKE_SUPPORT_H
#define ZR_VM_TESTS_AOT_C_TYPED_DIRECT_CALL_BOOL_SMOKE_SUPPORT_H
...
static void run_aot_c_typed_direct_call_bool_smoke_with_options(
    ...
    format_aot_c_typed_direct_call_bool_path(sourceDirectory,
                                             sizeof(sourceDirectory),
                                             testCase->projectDirectory,
                                             "src");
    format_aot_c_typed_direct_call_bool_path(binaryDirectory,
                                             sizeof(binaryDirectory),
                                             testCase->projectDirectory,
                                             "bin");
    format_aot_c_typed_direct_call_bool_path(generatedCDirectory,
                                             sizeof(generatedCDirectory),
                                             testCase->projectDirectory,
                                             "bin/aot_c/src");
    format_aot_c_typed_direct_call_bool_path(sharedLibraryDirectory,
