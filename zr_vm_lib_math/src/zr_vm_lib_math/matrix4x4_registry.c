...
const ZrLibTypeDescriptor *ZrMath_Matrix4x4Registry_GetType(void) {
    ...
    static const ZrLibMethodDescriptor kMethods[] = {
            {"translation",3,3,ZrMath_Matrix4x4_Translation,"Matrix4x4",ZR_NULL,ZR_TRUE,ZR_NULL,0},
            {"scale",3,3,ZrMath_Matrix4x4_Scale,"Matrix4x4",ZR_NULL,ZR_TRUE,ZR_NULL,0},
            {"rotationX",1,1,ZrMath_Matrix4x4_RotationX,"Matrix4x4",ZR_NULL,ZR_TRUE,ZR_NULL,0},
            {"rotationY",1,1,ZrMath_Matrix4x4_RotationY,"Matrix4x4",ZR_NULL,ZR_TRUE,ZR_NULL,0},
            {"rotationZ",1,1,ZrMath_Matrix4x4_RotationZ,"Matrix4x4",ZR_NULL,ZR_TRUE,ZR_NULL,0},
            {"identity",0,0,ZrMath_Matrix4x4_Identity,"Matrix4x4",ZR_NULL,ZR_TRUE,ZR_NULL,0},
            {"transpose",0,0,ZrMath_Matrix4x4_Transpose,"Matrix4x4",ZR_NULL,ZR_FALSE,ZR_NULL,0},
            {"determinant",0,0,ZrMath_Matrix4x4_Determinant,"float",ZR_NULL,ZR_FALSE,ZR_NULL,0},
            {"inverse",0,0,ZrMath_Matrix4x4_Inverse,"Matrix4x4",ZR_NULL,ZR_FALSE,ZR_NULL,0},
            {"mulVector",1,1,ZrMath_Matrix4x4_MulVector,"Vector4",ZR_NULL,ZR_FALSE,ZR_NULL,0},
            {"mulMatrix",1,1,ZrMath_Matrix4x4_MulMatrix,"Matrix4x4",ZR_NULL,ZR_FALSE,ZR_NULL,0},
    };
