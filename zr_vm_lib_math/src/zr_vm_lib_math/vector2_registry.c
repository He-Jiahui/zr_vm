...
const ZrLibTypeDescriptor *ZrMath_Vector2Registry_GetType(void) {
    ...
    static const ZrLibMethodDescriptor kMethods[] = {
            {"length", 0, 0, ZrMath_Vector2_Length, "float", ZR_NULL, ZR_FALSE, ZR_NULL, 0},
            {"lengthSquared", 0, 0, ZrMath_Vector2_LengthSquared, "float", ZR_NULL, ZR_FALSE, ZR_NULL, 0},
            {"normalized", 0, 0, ZrMath_Vector2_Normalized, "Vector2", ZR_NULL, ZR_FALSE, ZR_NULL, 0},
            {"dot", 1, 1, ZrMath_Vector2_Dot, "float", ZR_NULL, ZR_FALSE, ZR_NULL, 0},
            {"distance", 1, 1, ZrMath_Vector2_Distance, "float", ZR_NULL, ZR_FALSE, ZR_NULL, 0},
            {"lerp", 2, 2, ZrMath_Vector2_Lerp, "Vector2", ZR_NULL, ZR_FALSE, ZR_NULL, 0},
    };
