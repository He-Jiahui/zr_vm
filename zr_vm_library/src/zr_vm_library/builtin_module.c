...
static const ZrLibCanonicalTypeRoleDescriptor g_builtin_canonical_type_roles[] = {
        {"zr.builtin.TypeInfo",
        ...
        {"Class",
         ZR_CANONICAL_TYPE_ROLE_BUILTIN_METADATA_CLASS,
         ZR_CANONICAL_TYPE_ROLE_BUILTIN_METADATA_ROOT,
         ZR_CANONICAL_TYPE_SURFACE_NONE,
         ZR_CANONICAL_TYPE_PROJECTION_ERASED},
        {"Struct",
         ZR_CANONICAL_TYPE_ROLE_BUILTIN_METADATA_STRUCT,
         ZR_CANONICAL_TYPE_ROLE_BUILTIN_METADATA_ROOT,
         ZR_CANONICAL_TYPE_SURFACE_NONE,
         ZR_CANONICAL_TYPE_PROJECTION_ERASED},
        {"Function",
         ZR_CANONICAL_TYPE_ROLE_BUILTIN_METADATA_FUNCTION,
         ZR_CANONICAL_TYPE_ROLE_BUILTIN_METADATA_ROOT,
         ZR_CANONICAL_TYPE_SURFACE_CALLABLE_MEMBERS,
         ZR_CANONICAL_TYPE_PROJECTION_ERASED},
        {"Field",
         ZR_CANONICAL_TYPE_ROLE_BUILTIN_METADATA_FIELD,
         ZR_CANONICAL_TYPE_ROLE_BUILTIN_METADATA_ROOT,
         ZR_CANONICAL_TYPE_SURFACE_NONE,
         ZR_CANONICAL_TYPE_PROJECTION_ERASED},
        {"Method",
         ZR_CANONICAL_TYPE_ROLE_BUILTIN_METADATA_METHOD,
         ZR_CANONICAL_TYPE_ROLE_BUILTIN_METADATA_ROOT,
         ZR_CANONICAL_TYPE_SURFACE_CALLABLE_MEMBERS,
         ZR_CANONICAL_TYPE_PROJECTION_ERASED},
        {"Property",
         ZR_CANONICAL_TYPE_ROLE_BUILTIN_METADATA_PROPERTY,
         ZR_CANONICAL_TYPE_ROLE_BUILTIN_METADATA_ROOT,
         ZR_CANONICAL_TYPE_SURFACE_NONE,
         ZR_CANONICAL_TYPE_PROJECTION_ERASED},
        {"Parameter",
         ZR_CANONICAL_TYPE_ROLE_BUILTIN_METADATA_PARAMETER,
         ZR_CANONICAL_TYPE_ROLE_BUILTIN_METADATA_ROOT,
         ZR_CANONICAL_TYPE_SURFACE_NONE,
         ZR_CANONICAL_TYPE_PROJECTION_ERASED},
        {"Object",
         ZR_CANONICAL_TYPE_ROLE_BUILTIN_METADATA_OBJECT,
         ZR_CANONICAL_TYPE_ROLE_BUILTIN_METADATA_ROOT,
         ZR_CANONICAL_TYPE_SURFACE_NONE,
         ZR_CANONICAL_TYPE_PROJECTION_ERASED},
};
...
static const ZrLibModuleDescriptor g_builtin_descriptor = {
        ...
        g_builtin_canonical_type_roles,
        ZR_ARRAY_COUNT(g_builtin_canonical_type_roles),
        ZR_FALSE,
};
