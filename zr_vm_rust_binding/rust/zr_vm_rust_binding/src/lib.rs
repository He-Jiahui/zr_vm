    ...
    fn incremental_toggle_prunes_stale_intermediate_and_keeps_binary_run_stable(
        ...
        fs::write(
            ...
            concat!(
                ...
                "\n",
                "return decorated.verify() + decorated.bonus();\n",
            ),
        )?;
        fs::write(
    ...
    fn project_session_preserves_module_state_between_export_calls(
        ...
        fs::write(
            ...
            concat!(
                ...
                "}\n",
                "\n",
                "pub fn restoreState(state: string): void {\n",
