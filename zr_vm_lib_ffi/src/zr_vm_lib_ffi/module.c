...
static const ZrLibTypeDescriptor g_ffi_types[] = {
        ...
        ZR_LIB_TYPE_DESCRIPTOR_INIT("PointerHandle", ZR_OBJECT_PROTOTYPE_TYPE_CLASS, ZR_NULL, 0, g_pointer_methods,
                                    ZR_ARRAY_COUNT(g_pointer_methods), ZR_NULL, 0,
                                    "Typed pointer wrapper for native addresses.", ZR_NULL, ZR_NULL, 0, ZR_NULL, 0,
                                    ZR_NULL, ZR_FALSE, ZR_TRUE, "PointerHandle(type: object)", ZR_NULL, 0),
        ZR_LIB_TYPE_DESCRIPTOR_INIT("BufferHandle", ZR_OBJECT_PROTOTYPE_TYPE_CLASS, ZR_NULL, 0, g_buffer_methods,
